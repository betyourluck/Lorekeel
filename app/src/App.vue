...
onMounted(() => {
  ...
  unlistenGameEvents = transport.onEvent((name, payload) => {
    ...
    } else if (name === "edit-assist-progress") {
      game.editor.assist.log.push(String(payload)); // spec 29: 1 呼び出し 1 行
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <!-- 設定サウンドタブで読み上げ機能を有効にしたときだけ出す (imageGen と同型)。 -->
          <TtsControls v-if="game.ttsFeature" />
