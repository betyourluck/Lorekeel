...
export const messages = {
  ja: {
    ...
    state: {
      ...
      tabSynopsis: "あらすじ",
      tabMap: "マップ",
      tabProgressTitle: "進行 (ターン・現在地・目標・所持品・フラグ・この場にいる) — Ctrl+1 / Ctrl+Tab で切替",
      tabMapTitle: "マップ (行ける場所の地図) — Ctrl+2 / Ctrl+Tab で切替",
      tabSynopsisTitle: "あらすじ (これまでの章・最近の出来事) — Ctrl+3 / Ctrl+Tab で切替",
      tabFacts: "既成事実",
      tabFactsTitle: "既成事実 (GM が守る設定) — Ctrl+4 / Ctrl+Tab で切替",
      tabFiles: "ファイル",
  ...
  en: {
    ...
    state: {
      ...
      tabMap: "Map",
      tabProgressTitle: "Progress (turn, location, goals, inventory, flags, who's here) — Ctrl+1 / Ctrl+Tab to switch",
      tabMapTitle: "Map (where you can go) — Ctrl+2 / Ctrl+Tab to switch",
      tabSynopsisTitle: "Synopsis (chapters so far, recent events) — Ctrl+3 / Ctrl+Tab to switch",
      tabFacts: "Facts",
      tabFactsTitle: "Facts (settings the GM honors) — Ctrl+4 / Ctrl+Tab to switch",
      tabFiles: "Files",
