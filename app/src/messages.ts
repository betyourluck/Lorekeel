...
export const messages = {
  ja: {
    ...
    editAssist: {
      ...
      placeholder: "例: 主人公の HP を 12 にして / SAN 判定の challenge を 1 つ足して / モカの profile に趣味を足して",
      run: "実行",
      running: "直しています…",
      cancel: "取り消し",
  ...
  en: {
    ...
    editAssist: {
      ...
      placeholder: "e.g. set the hero's HP to 12 / add one SAN check challenge / add a hobby to Moka's profile",
      run: "Run",
      running: "Editing…",
      cancel: "Cancel",
