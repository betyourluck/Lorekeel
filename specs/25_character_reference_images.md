...
Phase C: Gemini / OpenAI edits とも参照 1 枚で見た目が引き継がれた (`data_contract` `settings_sheets` 末尾)。残 = ComfyUI 実機・
GUI 目視・outcast 側の書庫審査 (webp/4MB/3 枚) の実装。commits d26be5f (P0) / 6caa935 (A) / e9ede98 (B) / 本コミット (C)。rev1 の
